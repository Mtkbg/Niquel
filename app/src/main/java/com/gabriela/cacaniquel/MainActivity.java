package com.gabriela.cacaniquel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_2=findViewById(R.id.bt_02);
        bt_3=findViewById(R.id.bt_03);
        ...
        sair.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent tela = new Intent(getApplicationContext(), Teste.class);
                startActivity(tela);
            }
        });
    ...
    public void checarJogo(int a, int b, int c){
        if((a==7) && (b==7) && (c==7)){
            ...
            alertaVenceu.setMessage("Parabens, você é o vencedor!");
